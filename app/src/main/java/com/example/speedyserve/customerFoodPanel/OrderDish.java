...
import com.example.speedyserve.chefFoodPanel.UpdateDishModel;
import com.example.speedyserve.Customer;
import com.example.speedyserve.CustomerFoodPanel_BottomNavigation;
...
public class OrderDish extends AppCompatActivity {
    ...
    ImageView imageView;
    NumberPicker additem; // Replaced ElegantNumberButton with NumberPicker
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NumberPicker additem = findViewById(R.id.number_btn);
        additem.setMinValue(1);
        additem.setMaxValue(10);
        additem.setWrapSelectorWheel(true); // Wrap selector wheel


        // Configure NumberPicker
        additem.setMinValue(1);  // Set minimum value
        additem.setMaxValue(10); // Set maximum value
        additem.setValue(1); // Default value
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                additem.setOnValueChangedListener(new NumberPicker.OnValueChangeListener() {
                    ...
                    public void onValueChange(NumberPicker picker, int oldVal, int newVal) {
                        // Handle value change (number of items selected)
                    }
                });
                ...
                additem.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        // Handle button click to add item to cart
                                    ...
                                    if (ChefID.equals(cart1.getChefId())) {
                                        ...
                                        data.addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                int num = additem.getValue();  // Get the value from NumberPicker
